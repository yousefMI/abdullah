...
import 'package:graduation_ptoj/screens/map/model.dart';
import 'package:graduation_ptoj/screens/map/model1.dart';
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: TextFormField(
              decoration: const InputDecoration(
                  filled: true, fillColor: Colors.black38, hintText: "Search", suffixIcon: Icon(Icons.search)),
          ...
          Padding(
            ...
            child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(40.r))),height: 400,
              child: ClipRRect(borderRadius: BorderRadius.all(Radius.circular(40.r)),clipBehavior:Clip.antiAliasWithSaveLayer ,
                child: GoogleMap(
                  polylines: polylines,
                  markers: markers,
                  onTap: (argument) {
